...
void push()//добавить элемент
{
	...
	plist = p;
	count1++;
	cout << "Элемент был успешно добавлен в начало очереди." << endl;
	cout << "<------------------------------------------------>" << endl;
	return;
}
void pop()
{
	...
	count1--;
	cout << "Извлеченный элемент равен - " << k << '.' << endl;
	cout << "<------------------------------------------------>" << endl;
}
...
void max_el()
{
	...
	cout << "Максимальный элемент очереди равен - " << ma << endl;
	cout << "<------------------------------------------------>" << endl;
}
void main()
{
	...
	do {
		...
		cout << "3 - Вывод всех элементов очереди." << endl;
		cout << "4 - Удаление элемента очереди." << endl;
